...
public class PSO 
{
    ...
    public void applyPSO()
    {
        try
        {
            ...
            {
                int rk[][]=new int[dt.pop][dt.vmlist.size()];
                ...
                double de[][]=new double[dt.vmlist.size()][3];
                for(int i=0;i<dt.vmlist.size();i++)
                {
                ...
                for(int i=0;i<dt.vmlist.size();i++)
                {
                    for(int j=i+1;j<dt.vmlist.size();j++)
                    {
                        if(de[i][0]>de[j][0])
                        {
                            double t1=de[i][0];
                ...
                for(int pi=0;pi<dt.pop;pi++)
                {
                    ...
                    {                       
                        ...
                        //String g2[]=dt.vmlist.get(i).toString().split("\t");
                        double dur=Double.parseDouble(dt.vms[i][3]);
                        
                        double res=Double.parseDouble(dt.vms[i][2]);
                        if(res==0)
                            res=1;
